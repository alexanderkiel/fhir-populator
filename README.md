...
3. Install the package locally, using `python -m pip install .`
...
| v1.0.11 | 2021-06-04 | - handle Unicode filenames, especially on BSD/macOS (#1)<br>- do not serialize null ID for POST (#2)<br> - add LICENSE (BSD)|